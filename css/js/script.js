...
function initRsvpScreen() {
  ...
  const state = {
    ...
    adultsNoticeAcknowledged: false,
  ...
  const BLACKLIST = ["Олеся", "Олеська", "Олесечка", "Олесенька", "Олесюня", "Олесюнечка", "Олесюличка", "Олесюся", "Олесюсик", "Олесюсенька", "Олесюша", "Олесюшка", "Олесюшечка", "Олесёнок", "Олесёночек", "Олесёнчик", "Олесик", "Олесичка", "Олесинька", "Олеска", "Олесочка", "Олесушка", "Олесуля", "Олесулечка", "Олесуленька", "Олесуня", "Олесунечка", "Олесуляша", "Олесуляня", "Олесикс", "Олесяня", "Олесяша", "Олесяшечка", "Олесянчик", "Олесяночка", "Олесянка", "Леся", "Леська", "Лесечка", "Лесенька", "Лесюня", "Лесюнечка", "Лесюличка", "Лесюся", "Лесюсик", "Лесюсенька", "Лесюша", "Лесюшка", "Лесюшечка", "Лесёнок", "Лесёночек", "Лесёнчик", "Лесик", "Лесичка", "Лесинька", "Леска", "Лесочка", "Лесушка", "Лесуля", "Лесулечка", "Лесуленька", "Лесуня", "Лесунечка", "Лесуляша", "Лесуляня"];
function isBlacklistedName(value) {
  const firstName = getFirstName(value);
  return BLACKLIST.some(item => firstName === normalizeName(item));
}

  const RESTRICTED = ["Андрей", "Андрэй", "Андр", "Андрю", "Андрюша", "Андрюнечка", "Андрюшенька", "Андрюшка", "Андрюня", "Андрюняша", "Андрюлечка", "Андрюшечка", "Андрюха", "Андрюх", "Андрюхен", "Андрюхач", "Андрюхыч", "Андрон", "Дрон", "Дрю", "Дрюня", "Андрюшонок", "Андрюсик", "Андрюшик", "Андрюшуля", "Андрюшечек", "Андрюс", "Андрюсенька", "Андрюшкин", "Андроник", "Андроний", "Андрюф", "Андрюфчик", "Андрюфка", "Андрюган", "Андрюганчик", "Андрюганя", "Андрюнян", "Андрюнянчик", "Андрюняха", "Андрюняшка", "Андрюля", "Андрюлечек", "Андрюлечик", "Андрюляша", "Андрюляня", "Андрюляш", "Андрюся", "Андрюсечка", "Андрюсон", "Андрюсончик", "Андрюсоня", "Андрейка", "Андрейчик", "Андрейчонок", "Андрейчек", "Андрейчоня", "Андрейчончик", "Андрейчикс", "Андрейко", "Андрейчико", "Андрейчикыч", "Андрейкаша", "Андрейчушка", "Андрейчуня", "Андрейчикон", "Андрейчуля", "Андрейчуляша", "Александр", "Александра", "Александрик", "Александрушка", "Александрушечка", "Алексаша", "Алексашка", "Алекса", "Алекс", "Алексан", "Саша", "Саня", "Саш", "Сашка", "Сашок", "Сашуля", "Сашенька", "Сашечка", "Сашуня", "Сашунечка", "Сашуличка", "Сашуся", "Сашусик", "Сашусенька", "Сашулик", "Сашуляня", "Сашуляша", "Сашуняша", "Сашура", "Сашурка", "Сашурик", "Сашурочка", "Сашуренька", "Сашонок", "Сашончик", "Сашонечка", "Сашоня", "Сашонечек", "Сашик", "Сашичка", "Сашинька", "Сашкин", "Сашулян", "Сашулянчик", "Сашуляшка", "Сашундра", "Сашундрик", "Сашуняндра", "Сашулёк", "Сашулечка", "Сашуняшик", "Денис", "Дениска", "Денисик", "Денисочка", "Денисонька", "Денисушка", "Денисулечка", "Денисюша", "Денисюня", "Денисюнечка", "Денисюлечка", "Денисюся", "Денисёнок", "Денисёнчик", "Денисёк", "Денисечка", "Денисечек", "Денисуля", "Денисуленька", "Денисикс", "Денчик", "Деня", "Денёк", "Денюша", "Денюня", "Денюнечка", "Денюлечка", "Денюся", "Денюсик", "Денюсенька", "Денисыч", "Дэн", "Дэнис", "Ден"];
function isRestrictedGuest(value) {
  const firstName = getFirstName(value);
  return RESTRICTED.some(item => firstName === normalizeName(item));
}
  ...
  function adultsNoticePassed() {
    return state.adultsNoticeAcknowledged;
  }
  ...
  function renderRsvp() {
    ...
    if (!adultsNoticePassed()) {
      pieces.push(`
        <div class="rsvp-block ${getStepClass('adultsNotice')}">
          <div class="rsvp-banner rsvp-banner--notice ${getStepClass('adultsNoticeBanner')}">
            <div class="rsvp-banner-title">Дорогие гости</div>
            <div class="rsvp-banner-divider" aria-hidden="true"></div>
            <div class="rsvp-banner-text">
              Мы очень любим ваших малышей, но в этот день хотим провести наш праздник в формате вечера для взрослых (15+). Будем благодарны за ваше понимание 🤍
            </div>
          </div>

          <div class="rsvp-submit-wrap ${getStepClass('adultsNoticeContinue')}">
            <button class="rsvp-submit" type="button" data-action="acknowledgeAdultsNotice">
              Понятно
            </button>
          </div>
        </div>
    ...
    pieces.push(`
        <div class="rsvp-block ${getStepClass('name')}">
          <h3 class="rsvp-block-title">Как к вам обращаться?</h3>
...
if (RSVP_ENDPOINT) {
  ...
  function resetState() {
    ...
    state.attendance = null;
    state.adultsNoticeAcknowledged = false;
    state.restrictedAcknowledged = false;
    state.fillingType = null;
    state.guests = '';
    state.guestsCommitted = false;
  ...
  function focusAdultsNoticeButton() {
    const adultsNoticeButton = rsvpRoot.querySelector('[data-action="acknowledgeAdultsNotice"]');
    if (!adultsNoticeButton) return;
    adultsNoticeButton.focus();
  }
  ...
  rsvpRoot.addEventListener('click', (event) => {
    ...
    if (action === 'acknowledgeAdultsNotice') {
      state.adultsNoticeAcknowledged = true;
      renderRsvp();
